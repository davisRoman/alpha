...
static void __init imx6sx_clocks_init(struct device_node *ccm_node)
{
	...
	imx_clk_set_rate(clks[IMX6SX_CLK_AUDIO_PODF], 12288000);
...
//	imx_clk_set_parent(clks[IMX6SX_CLK_ECSPI_SEL], clks[IMX6SX_CLK_PLL3_60M]);
//	imx_clk_set_rate(clks[IMX6SX_CLK_ECSPI_PODF], 60000000);
...
//	imx_clk_set_parent(clks[IMX6SX_CLK_QSPI2_SEL], clks[IMX6SX_CLK_PLL2_PFD2]);
