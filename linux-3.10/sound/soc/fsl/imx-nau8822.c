...
static int imx_nau8822_hw_params(struct snd_pcm_substream *substream,
...
static struct snd_soc_ops imx_nau8822_ops = {
    .hw_params = imx_nau8822_hw_params,
};
...
static struct snd_soc_card snd_soc_card_imx = {
    .name        = "imx-audio-nau8822",
    .dai_link    = imx_nau8822_dai,
    .num_links    = ARRAY_SIZE(imx_nau8822_dai),
    .dapm_widgets = imx_nau8822_dapm_widgets,
    .num_dapm_widgets = ARRAY_SIZE(imx_nau8822_dapm_widgets),
};
...
MODULE_DESCRIPTION("ALSA SoC imx nau8822");
